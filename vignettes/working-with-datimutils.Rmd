---
title: "working-with-datimutils"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{working-with-datimutils}
...
```{r}
dplyr::mutate(data,    dataElementName = datimutils::getDataElements(dataElement))
...
data <- getMetadata(
  ...
  "organisationUnitGroups.name:eq:State",
