...
meningitis_years <-  c(2021, 2022, 2023)
...
indicator_name <-  get_indicator_name(id = "SruoPzzt3ES")
...
indicator_name <-  get_indicator_name(id = "iOUKrRANJwi")
...
indicator_name <-  get_indicator_name(id = "yH7RI3urgYi")
...
indicator_name <-  get_indicator_name(id = "BWBsbKHaCrz")
...
indicator_name <-  get_indicator_name(id = "snrl5tiWGLE")
