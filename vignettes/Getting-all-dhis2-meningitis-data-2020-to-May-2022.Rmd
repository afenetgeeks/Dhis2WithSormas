...
write_csv(x = meningitis_coverage_annualized,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/meningitis_coverage_annualized.csv")
...
write_csv(x = meningitis_coverage_monthly,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/meningitis_coverage_monthly.csv")
```
...
write_csv(x = men_A_given,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/men_A_given.csv")
...
write_csv(x = men_A_Received,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/men_A_Received.csv")
...
write_csv(x = men_A_OB,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/men_A_OB.csv")
...
write_csv(x = men_A_Doses_Opened,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/men_A_Doses_Opened.csv")
```
