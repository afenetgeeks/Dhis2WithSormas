...
measles_sormas_cleaned <- sormas_cleaner("/Volumes/Robinson/Afenet-projects/afenet-nigeria/Dhis2WithSormas/data-raw/sormas_measles_cases_Dec_2023.csv", disease = "measles")
...
```{r}
measles_alt_denominator <- get_2_dose_alt_denominator(
                            sormas_cleaned =  measles_sormas_cleaned,
...
dbAppendTable(connection , name = "measles_alt_denominator2", value = measles_alt_denominator )
...
dbAppendTable(connection, name = "measles_age_group2", value = measles_age_group )
...
dbAppendTable(connection, name = "measles_stock_analysis2", 
...
dbAppendTable(connection, name = "mcv1_mcv2_dropout_rate2", value = mcv1_mcv2_dropout_rate )
...
dbAppendTable(connection, name = "measles_yf_discrepancy2", value = measles_yf_discrepancy )
...
dbAppendTable(connection, name = "measles_coverage_map2", value = measles_coverage_map )
