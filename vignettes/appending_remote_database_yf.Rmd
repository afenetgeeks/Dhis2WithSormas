...
```{r}
sormas_yellow_fever_cleaned <- sormas_cleaner("/Volumes/Robinson/Afenet-projects/afenet-nigeria/Dhis2WithSormas/data-raw/sormas_yf_cases_Dec_2023.csv", disease = "yellow fever")
```
...
dbAppendTable(connection , name = "yf_alt_denominator2", value = yf_alt_denominator )
