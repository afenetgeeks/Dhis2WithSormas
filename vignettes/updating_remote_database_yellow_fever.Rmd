...
updated_remote_database(dataset = bind_rows( filter(yf_age_group, State == "Federal Capital Territory"),
...
```{r}
yf_coverage_annually <- read_csv("/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/yf_coverage_annualized.csv")
...
updated_remote_database(
  dataset = bind_rows( filter(yf_coverage_map, State == "Federal Capital Territory"),
                     ...
                     aws_datatable = "yf_coverage_map",starting_index = 1)
