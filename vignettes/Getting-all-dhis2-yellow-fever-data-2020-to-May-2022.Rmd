...
write_csv(x = yf_coverage_annualized,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/yf_coverage_annualized.csv")
```
...
write_csv(x = yf_coverage_monthly,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/yf_coverage_monthly.csv")
```
...
write_csv(x = yf_Vaccine_Given,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/yf_Vaccine_Given.csv")
...
write_csv(x = yf_Received,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/yf_Received.csv")
...
write_csv(x = yf_OB,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/yf_OB.csv")
...
write_csv(x = yf_Doses_Opened,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/yf_Doses_Opened.csv")
```
