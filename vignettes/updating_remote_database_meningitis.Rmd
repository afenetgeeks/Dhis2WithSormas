...
updated_remote_database(dataset = bind_rows( filter(meningitis_age_group, State == "Federal Capital Territory"),
...
updated_remote_database(dataset = bind_rows( filter(men_A_stock_analysis, State == "Federal Capital Territory"), filter(men_A_stock_analysis, State != "Federal Capital Territory") ), 
