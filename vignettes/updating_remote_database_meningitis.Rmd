...
```{r}
sormas_meningitis_cleaned <- sormas_cleaner("/Volumes/Robinson/Afenet-projects/afenet-nigeria/Dhis2WithSormas/data-raw/sormas_men_A_cases_2017_2023.csv",disease = "meningitis (csm)")
...
#dbWriteTable(connection , name = "men_A_alt_denominator2", value = men_A_alt_denominator %>% slice(1:2), overwrite = TRUE)
...
updated_remote_database(connection = connection,
                        ...
                        aws_datatable = "men_A_alt_denominator2", 
                       starting_index = 27001)
```
...
updated_remote_database(connection,
  dataset = bind_rows( filter(measles_men_A_discrepancy, State == "Federal Capital Territory"),
                     ...
                     aws_datatable = "measles_men_A_discrepancy",starting_index = 65001)
```
...
updated_remote_database(connection = connection,
  dataset = bind_rows( filter(men_A_coverage_map, State == "Federal Capital Territory"),
                     ...
                     aws_datatable = "men_A_coverage_map",starting_index = 26001)
