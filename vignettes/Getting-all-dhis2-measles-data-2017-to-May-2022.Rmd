...
dw <- config::get("development_stream2")
 ...
 get_indicator_name <-function(id){
   
   dhis2_connection_small$get_analytics(analytic = id,
                                 org_unit = "LEVEL-1",
                                 period = "202005",
                                  output_scheme = "NAME"
...
indicator_name <-  get_indicator_name(id = "hvYqrmR6MPq")
...
indicator_name <-  get_indicator_name(id = "Fbj3AkYjCie")
...
indicator_name <-  get_indicator_name(id = "tb5NGUMB9dQ")
...
indicator_name <-  get_indicator_name(id =  "qagHWllYle8")
...
indicator_name <-  get_indicator_name(id =  "j6mCLL1X4yG")
...
indicator_name <-  get_indicator_name(id =  "oB7SLTRHciH")
...
indicator_name <-  get_indicator_name(id =  "XklyJxzoyxR")
...
indicator_name <-  get_indicator_name(id =  "vtHJVTAguch")
...
indicator_name <-  get_indicator_name(id =  "hg1D2tXg3aB")
