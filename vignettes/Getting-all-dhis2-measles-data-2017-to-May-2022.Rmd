...
write_csv(x = measles1_coverage_annualized,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/measles1_coverage_annualized.csv")
```
...
write_csv(x = measles2_coverage_annualized,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/measles2_coverage_annualized.csv")
```
...
write_csv(x = measles1_coverage_monthly,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/measles1_coverage_monthly.csv")
```
...
write_csv(x = measles2_coverage_monthly, 
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/measles2_coverage_monthly.csv")
```
...
write_csv(x = measles1_given,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/measles1_given.csv")
```
...
write_csv(x = measles2_given,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/measles2_given.csv")
```
...
write_csv(x = measles_Received,file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/measles_Received.csv")
```
...
write_csv(x = measles_OB,file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/measles_OB.csv")
```
...
measles_Opened_Used <- measles_Opened_Used%>% mutate(Indicator =indicator_name)



write_csv(x = measles_Opened_Used,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/measles_Opened_Used.csv")
...
write_csv(x = measles1_coverage_annualized_all_time,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/measles1_coverage_annualized_all_time.csv")
```
...
write_csv(x = measles2_coverage_annualized_all_time,
          file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/measles2_coverage_annualized_all_time.csv")
...
write_csv(x = measles_new_cases_less_5years,file = "/Volumes/Robinson/Afenet-projects/Dhis2WithSormas/data-raw/measles_new_cases_less_5years.csv")
```
